...
public class SalesmanController {
	...
	@RequestMapping(value = "/salesman", params = "act=query1")
	public String doQueryAll1(HttpServletRequest req,Salesman s){
		System.out.println("--s="+s);
		String str = "/salesman_ckgly/query.jsp"; 
		List<Salesman> list = service.queryAll(s);
		req.setAttribute("list", list);
		return str;
	}
	
	@RequestMapping(value = "/salesman", params = "act=add1")
	public String doAdd1(HttpServletRequest req,Salesman s){
		System.out.println("--doadd");
		String str = "";
		int i = service.add(s);
		if (i>0) {
			str = "/salesman_ckgly/querysalesman.jsp";
		} else {
			System.out.println("--add error");
		}
		return str;
	...
	@RequestMapping(value = "/salesman", params = "act=toUpdate1")
	public String doToUpdate1(HttpServletRequest req,Salesman s){
		System.out.println("--doToUpdate");
		String str = "/salesman_ckgly/update.jsp";
		Salesman s2 = service.queryById(s.getSalesno());
		req.setAttribute("s", s2);
		return str;
	}
	
	@RequestMapping(value = "/salesman", params = "act=update1")
	public String doUpdate1(HttpServletRequest req,Salesman s){
		System.out.println("--doupdate");
		System.out.println("--s="+s);
		String str = "/salesman_ckgly/update.jsp";
		int i = service.update(s);
	...
	@RequestMapping(value = "/salesman", params = "act=delete1")
	public String doDelete1(HttpServletRequest req,Salesman s, String salesnos){
		System.out.println("--doDelete");
		//String str = "/salesman/query.jsp";
		String str = "/salesman.action?act=query1";
		int i = service.delete(salesnos);
		if (i>0) {
			System.out.println("delete ok!");
		} else {
