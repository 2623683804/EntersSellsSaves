			...
			<div class="row" id="row1">
				<div class="panel panel-default col-md-6 col-md-offset-3">
					...
					<div class="panel-body">
						<div class="col-md-12">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/supplier.action?act=add" method="post">
				...
				onclick="location.href='<%=request.getContextPath()%>/supplier/querysupplier.jsp';" />
								</div>
							</form>
						</div>
					</div>
