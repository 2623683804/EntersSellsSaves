	...
	<body>
		...
		<div class="container-fluid" id="cf">
			<ol class="breadcrumb">
				...
				<li>
					<a href="<%=request.getContextPath() %>/customer_ckgly/querycustomer.jsp">客户资料维护</a>
				</li>
				<li class="active">修改客户资料</li>
			</ol>
		</div>
		<div class="container">
			<div class="row" id="row1">
				<div class="panel panel-default col-md-6 col-md-offset-3">
					<center>
						<div class="panel-heading" id="welcome"><font size="4"><b>修改客户资料</b></font></div>
					</center>

					<div class="panel-body">
						<div class="col-md-12">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/customer.action?act=update" method="post">
								<input type="hidden" name="cusno" value="${c.cusno }"/>
								...
								<div class="col-md-6">
									<input type="button" value="取消返回" class="btn btn-default btn-block" onclick="location.href='<%=request.getContextPath()%>/customer_ckgly/querycustomer.jsp';" />
								</div>
							</form>
						</div>
					</div>
