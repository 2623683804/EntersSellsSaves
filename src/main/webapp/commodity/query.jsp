		...
		<div class="container-fluid">
			...
			<div class="navbar-form navbar-left">
				<div class="form-group">
					<form action="<%=request.getContextPath()%>/commodity.action?act=query" method="post">
				...
				<c:if test="${list != null && list.size()>0 }">
					<c:forEach items="${list }" var="c">
						<tr>
							...
							<td width="5%">
								<a href="${pageContext.request.contextPath }/commodity.action?act=toUpdate&comno=${c.comno}"class="btn btn-primary">编辑</a>
							</td>
						</tr>
					</c:forEach>
				</c:if>
