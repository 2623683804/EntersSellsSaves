			...
			<div class="row" id="row1">
				<div class="panel panel-default col-md-6 col-md-offset-3">
					...
					<div class="panel-body">
						<div class="col-md-12">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/supplier.action?act=update1" method="post">
								...
								<div class="col-md-6">
									<input type="button" value="取消返回" class="btn btn-default btn-block" onclick="location.href='<%=request.getContextPath()%>/supplier_ckgly/querysupplier.jsp';" />
								</div>
							</form>
						</div>
					</div>
