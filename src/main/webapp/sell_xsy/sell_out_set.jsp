	...
	<div class="container-fluid">
		...
		<form class="form-horizontal navbar-form navbar-right">
			...
			<div id="div_set">
				...
				<form  action="<%=request.getContextPath()%>/sell.action?act=toUpdate1"
				method="post">
				<input type="hidden" name="selloutid"  value="${sell.selloutid}"/>
					...
					<a href="<%=request.getContextPath()%>/sell_xsy/sell_output_query.jsp" id="cancel_01" class="btn btn-default" type="button">取消修改</a>
				</form>
			</div>
