			...
			<div class="row" id="row1">
				<div class="panel panel-default col-md-6 col-md-offset-3">
					...
					<div class="panel-body">
						<div class="col-md-12">
							<form class="form-horizontal" action="<%=request.getContextPath()%>/salesman.action?act=add" method="post">
				...
				onclick="location.href='<%=request.getContextPath()%>/salesman/querysalesman.jsp';" />
								</div>
							</form>
						</div>
					</div>
