	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<div class="list-group" id="lg">
								<a href="<%=request.getContextPath()%>/user/UDate.jsp" class="list-group-item">修改密码</a>
			...
			<div class="navbar-form navbar-left">
				<div class="form-group">
					<form action="<%=request.getContextPath()%>/salesman.action?act=query" method="post">
				...
				<c:if test="${list != null && list.size()>0 }">
					<c:forEach items="${list }" var="s">
						<tr>
							...
							<td>${s.address }</td>
							<td width="5%">
								<a href="${pageContext.request.contextPath }/salesman.action?act=toUpdate&salesno=${s.salesno}"class="btn btn-primary">编辑</a>
							</td>
						</tr>
					</c:forEach>
				</c:if>
	...
	<div class="row">
		<div class="col-md-1 col-md-offset-5">
			<input type="button" value="添加" class="btn btn-primary btn-block"
				onclick="location.href='<%=request.getContextPath()%>/salesman/add.jsp';" />
		</div>
		<div class="col-md-1">
