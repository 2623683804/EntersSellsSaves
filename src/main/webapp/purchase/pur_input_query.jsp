	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand"
				href="<%=request.getContextPath()%>/zhuye.jsp"> <img
				alt="Brand"
		...
		<ul class="nav navbar-nav" id="nav">
			<li class="active"><a
				href="<%=request.getContextPath()%>/zhuye.jsp">Home</a></li>
			...
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					<div class="list-group" id="lg">
						<a href="<%=request.getContextPath()%>/user/UDate.jsp"
							class="list-group-item">维护用户资料</a> <a
							href="<%=request.getContextPath()%>/user/powerQuery.jsp"
	...
	<div class="container" id="containe">
		<div>
			<form class="form-inline" name="search" class="search" id="myForm"
				method="post"
				action="<%=request.getContextPath()%>/purinput.action?act=query">
