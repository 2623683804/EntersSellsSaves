	...
	<div class="container" id="containe">
		<div>
			<form class="form-inline" name="search" class="search" id="myForm"
				method="post"
				action="<%=request.getContextPath()%>/purinput.action?act=query1">
		...
		<div id="div_entering">
			<form
				action="<%=request.getContextPath()%>/purinput.action?act=purinputadd1"
				method="post">
				<div class="form-group">
						...
						<c:forEach items="${list }" var="puri">
							<tr>
								...
								<td><a class=" set btn btn-warning btn-sm" type="button"
									role=button
									href="${pageContext.request.contextPath }/purinput.action?act=update1&purinid=${puri.purinid}">
										修改</a> <a class="btn btn-danger btn-sm" type="button" role=button
									href="${pageContext.request.contextPath }/purinput.action?act=delete1&purinid=${puri.purinid}"
