...
<body>
	...
	<div class="container" id="containe">
		...
		<div id="div_set">
			...
			<form method="post" 
				action="${pageContext.request.contextPath }/puroutput.action?act=toUpdate1">
				...
				<input type="submit" id="submit_02" value="保存"
					...
					<a href="<%=request.getContextPath()%>/purchase_xsy/pur_return_query.jsp" id="cancel_01" class="btn btn-default" type="button">取消修改</a>
			</form>
		</div>
